...
| `019eef10-6b2d-7662-a8d6-1811ceb6ccee` | S9-S11 workflow-governor stage audit | FAIL | S9 numeric gate review, S10 missing reflections, and S11 final acceptance audit added; S11 remains open |
...
| `019eef23-7d94-7411-ba16-d9b37476dcd4` | S9-S11/package and receipt re-audit | PASS_WITH_LIMITATION | Confirmed then-current zip entry count, then-current L2 counts, then-current pytest count, no private payloads, and S11 still open |
...
From `reports/IST_VERIFICATION_RECEIPTS.json`:
